...
function Login() {
  ...
  const handleOtpChange = (e, index) => {
    ...
    setOtpCode(newOtp);
    if (e.target.value && index < 5) otpInputRefs.current[index + 1].focus();
  };
  ...
  const handleVerifyAccount = async () => {
    ...
    try {
      const res = await axios.post(
        ...
        { userId: unverifiedUserId, otp: otpCode.join("") },
        { withCredentials: true }
      );
  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="left-section">
        <h1 className="brand-name">HostelHub</h1>
        <p className="brand-tagline">This is your login page</p>
        <p className="brand-text">
          Find, book, and manage your hostel easily. Safe • Affordable • Student Friendly
        </p>
      </div>
      ...
      <div className="login-page">
        <div className="login-card">
          <h1 className="login-title">
            {step === 1 ? <>Welcome to Back <span>Back</span></> : "Verify Your Account"}
          </h1>
          ...
          {step === 1 && (
            <>
              ...
              <Link to="/resetpass" className="forgot-link">
                Forgot Password?
              </Link>
