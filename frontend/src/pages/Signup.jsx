  ...
  return (
    <div className="signup-page-wrapper">
      ...
      <div className="signup-left">
        ...
        <p className="brand-subtitle">Your Student Hostel Companion</p>
        <p className="brand-text">
          Find, book, and manage hostels easily. Safe, affordable, and student-friendly.  
          Start your journey with HostelHub and enjoy hassle-free hostel experience.
        </p>
      </div>
      ...
      <div className="signup-right">
        <div className="signup-card">
          ...
          <h3 className='signup-subtitle'>Welcome! Please fill in the details to get started.</h3>
          ...
          <div className="signup-form">
            ...
            <button
              ...
              disabled={
                loading ||
                (!awaitingVerification && (!email || !name || !password || !confirmPassword)) ||
                (awaitingVerification && !verificationCode)
              }
              className="primary-btn"
            >
              {loading
                ? awaitingVerification ? 'Verifying...' : 'Signing up...'
                : awaitingVerification ? 'Verify' : 'Sign up'}
            </button>
